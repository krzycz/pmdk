# Contributing to the NVM Library for Windows

Here you'll find instructions on how to contribute to the NVM Library.

At first, please get familiar with the instructions in CONTRIBUTING.md.

How to build NVM Library for Windows:

1. Install Microsoft Visual Stufdio 2015
2. Install GIT (https://git-scm.com/download/win

2. Open <nvm>/win/NVML.sln
